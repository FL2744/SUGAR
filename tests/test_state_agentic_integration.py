...
def test_integrator_context_is_bounded_and_includes_specialist_cited_country_case():
    base_packet = {
    ...
    assert packet["integration_context"]["strategy"] == "high-priority baseline plus specialist-cited cases"

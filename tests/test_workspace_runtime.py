...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("partner.import.json", "external-import", "import_manifest"),
        ("partner.rejected.jsonl", "external-import", "import_rejections"),
        ("partner.jsonl", "external-import", "import"),
        ("partner.csv", "external-import", "import_view"),
        ("partner.xlsx", "external-import", "import_view"),

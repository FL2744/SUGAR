...
class SettingsPage(QWidget):
    ...
    def __init__(self) -> None:
        ...
        self.mastodon_token = PasswordField("Mastodon access token (read:search)")
        ...
        source_grid.addWidget(LabeledRow("Mastodon token", self.mastodon_token, "Required for status search; request read:search from your instance."), 1, 1)

...
def build_observations() -> list[ResearchObservation]:
    return [
        _observation(
            ...
            actors=[
                "China Cultural Center in Bishkek",
                "Kyrgyz National Historical Museum",
                "PRC Embassy in Kyrgyzstan",
            ],
        ...
        _observation(
            ...
            actors=[
                ...
                "Confucius Institute at Osh State University",
            ],
        ...
        _observation(
            ...
            actors=[
                ...
                "SCO Secretariat",
                "Kyrgyz Ministry of Culture, Information and Youth Policy",
        ...
        _observation(
            ...
            actors=[
                "Nanjing City People's Government",
                "China Cultural Center in Bishkek",
                "Kyrgyz cultural and scientific organizations",
            ],
...
def build_assessments(observations: list[ResearchObservation]) -> list[StateAssessment]:
    ...
    specs = [
        (
            ...
            ["general_public"],
            ["culture_arts"],
            ["culture_civilization", "local_partnership"],
            ["China Cultural Center in Bishkek"],
            ["Kyrgyz National Historical Museum"],
            "official_prc_source",
            ...
            ["exhibition", "in_person"],
            ["cultural programming", "institutional partnership"],
            "normal",
        ),
        (
            "Osh State University–Xinjiang Normal University Confucius Institute cooperation extended",
            ["students", "educators", "researchers_academics"],
            ["higher_education", "other"],
            ["education_opportunity", "local_partnership"],
            ["Xinjiang Normal University", "Confucius Institute at Osh State University"],
            ["Osh State University"],
            ...
            ["institutional_program", "language_instruction", "cultural_program"],
            ["Chinese-language education", "higher-education partnership"],
            "high",
        ),
        (
            ...
            ["PRC Embassy in Kyrgyzstan"],
            ["Alykul Osmonov National Library of Kyrgyzstan"],
            "official_prc_source",
            ...
            ["materials", "in_person", "language_instruction"],
            ["Chinese-language education", "curriculum support"],
            "high",
        ),
        (
            "International Chinese Language Day events at Bishkek universities",
            ["students", "youth", "educators"],
            ["culture_arts", "other"],
            ["culture_civilization", "education_opportunity"],
            ["PRC Embassy in Kyrgyzstan", "Confucius Institutes"],
            ["International University of Kyrgyzstan", "Bishkek State University"],
            "official_prc_source",
            ...
            ["language_instruction", "exhibition", "performance", "in_person"],
            ["Chinese-language education", "youth engagement", "cultural programming"],
            "high",
        ),
        (
            ...
            ["youth", "students"],
            ["culture_arts", "other"],
            ["education_opportunity", "culture_civilization"],
            ["PRC Embassy in Kyrgyzstan", "Confucius Institute at KNU"],
            ...
            ["competition", "language_instruction", "in_person"],
            ["Chinese-language education", "youth engagement"],
            "high",
        ),
        (
            ...
            ["PRC Embassy in Kyrgyzstan"],
            ["Kyrgyz Ministry of Foreign Affairs charity bazaar"],
            "official_prc_source",
            ...
            ["public_event", "performance", "food_and_crafts"],
            ["public cultural programming"],
            "normal",
        ),
        (
            "Kyrgyz and Chinese writers organizations sign cooperation agreement",
            ["researchers_academics", "general_public"],
            ["culture_arts"],
            ["local_partnership", "culture_civilization"],
            ["Chinese Writers' Association"],
            ["Writers' Union of Kyrgyzstan"],
            ...
            ["institutional_partnership", "literary_exchange"],
            ["literary networks", "translation", "institutional partnership"],
            "normal",
        ),
        (
            "Presentation of Xi Jinping's The Governance of China in Bishkek",
            ["government_officials", "journalists_media", "researchers_academics"],
            ["civic_engagement", "other"],
            ["china_model", "multipolarity"],
            ["Chinese organizers reported by Kabar"],
            ["Kyrgyz participants"],
            "credible_secondary_reporting",
            ...
            ["book_presentation", "elite_dialogue"],
            ["governance narratives", "elite engagement", "media and think-tank engagement"],
            "high",
        ),
        (
            "SCO Civilizations Dialogue at the National Historical Museum",
            ["government_officials", "journalists_media", "researchers_academics"],
            ["culture_arts", "civic_engagement"],
            ["culture_civilization", "multipolarity"],
            [
                "PRC State Council Information Office",
                "China International Communications Group",
                "PRC Embassy in Kyrgyzstan",
            ],
            ["Kyrgyz Ministry of Culture, Information and Youth Policy", "Kyrgyz National Historical Museum"],
            "official_prc_source",
            ...
            ["conference", "exhibition", "elite_dialogue"],
            ["multilateral cultural diplomacy", "media cooperation", "governance narratives"],
            "high",
        ),
        (
            "Chinese-produced Manas dance drama premieres in Kyrgyzstan",
            ["general_public", "government_officials"],
            ["culture_arts"],
            ["culture_civilization", "local_partnership"],
            ["Kizilsu Kyrgyz Autonomous Prefecture song and dance troupe", "PRC Embassy in Kyrgyzstan"],
            ["Kyrgyz cultural institutions"],
            "official_prc_source",
            ...
            ["performance", "public_event"],
            ["shared-heritage cultural diplomacy", "mass-audience programming"],
            "high",
        ),
        (
            "Nanjing Week opens at the Osmonov National Library",
            ["general_public", "researchers_academics"],
            ["culture_arts"],
            ["culture_civilization", "local_partnership"],
            ["Nanjing City People's Government"],
            ["Alykul Osmonov National Library of Kyrgyzstan"],
            ...
            ["festival", "literary_exchange", "subnational_diplomacy"],
            ["city diplomacy", "cultural and literary exchange"],
            "normal",
        ),
    ]
...
def build_us_presence_sites() -> list[USPresenceSite]:
    ...
    physical = [
        ...
        (
            "America Corner Jalal-Abad",
            "Jalal-Abad",
            40.9333,
            73.0000,
            ["english_language", "culture", "professional_skills", "media_literacy", "entrepreneurship", "technology"],
        ),
        ...
        (
            "American Corner Karakol",
            "Karakol",
            42.4907,
            78.3936,
            ["english_language", "culture", "professional_skills"],
        ),

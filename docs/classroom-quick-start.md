...
7. For a no-key workflow, click **Prepare Manual Review** after collecting or importing records. This creates unreviewed observation and assessment drafts directly from source records. Alternatively, configure an LLM key in **Settings** for AI triage and assessment suggestions. **Export Human Review Workbook**, make the named analyst decisions in that workbook, save it, and click **Apply Human Review**. Export and verify the handoff. The bundle carries the requirement, approved compiled strategy, plan, evidence, reviewed observations, assessments, provenance, limitations, and lineage together.
